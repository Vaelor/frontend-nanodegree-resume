...
var work = {
    'jobs': [
        {
            'employer': 'Sunset Sarsaparilla',
            'title': 'Junior bottle filling',
            'location': 'California',
            'dates': '05.06.2073 - 01.01.2077',
            'description': 'Filling Sunset Sarsaparilla bottles'
        },
        {
            'employer': 'Nuka Cola',
            'title': 'Senior bottle filling',
            'location': 'Boston',
            'dates': '01.01.2077 - 23.10.2077',
            'description': 'Filled bottles, sadly got whiped out after the nuclear Fallout in  2077. Got no resume.'
        }
    ],

    'display': function() { showWork(); }
};